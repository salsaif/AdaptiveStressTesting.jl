...
export TransitionModel, Params, State, Action,
Reward, Policy, solve, simulate
...
function simulate(model::TransitionModel,p::Params,policy::Policy,rng::AbstractRNG=MersenneTwister();verbose::Bool=false)
  ...
  return cum_reward::Reward, actions::Array{Action,1}
end
